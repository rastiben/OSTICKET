...
class CloseEvent extends ThreadEvent {
    ...
    function getDescription($mode=self::MODE_STAFF) {
        // avec le statut {<TicketStatus>data.status}
        //if ($this->getData('status'))
            return $this->template(__('Fermé par <b>{somebody}</b> le {timestamp}'));
        //else
            //return $this->template(__('Fermé par <b>{somebody}</b> {timestamp}'));
    }
}
...
class CreationEvent extends ThreadEvent {
    ...
    function getDescription($mode=self::MODE_STAFF) {
        return $this->template(__('Créé par <b>{somebody}</b> {timestamp}'));
    }
}
...
class ReopenEvent extends ThreadEvent {
    ...
    function getDescription($mode=self::MODE_STAFF) {
        return $this->template(__('Rouvert par <b>{somebody}</b> {timestamp}'));
    }
}
