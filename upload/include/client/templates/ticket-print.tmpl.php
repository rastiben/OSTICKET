...
<?php } ?>
    <div class="hr">&nbsp;</div>
        <div class="flush-left"><?php echo (string) $ost->company; ?></div>
...
<div class="title">
    <h1>Ticket n° <span><?php echo $ticket->getNumber(); ?></span></h1>
    <h5><span><?php echo $ticket->getOwner()->getName(); ?></span> le <span><?php echo Format::datetime($ticket->getCreateDate()); ?></span></h5>
</div>
<br>
<div class="logo_vdoc">
<img src="<?php echo INCLUDE_DIR . 'fpdf/logo_OK.jpg'; ?>"/>
<div class="info">
    <p>Status : </p>
</div>
</div>
