...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!$this->tabs) {
            ...
            $this->tabs['tasks'] = array('desc'=>'Tâches', 'href'=>'tasks.php', 'title'=>__('Task Queue'));
            ...
            $this->tabs['Matériel de prêt'] = array('desc'=>'Matériel de prêt','href'=>'pret.php','title'=>__('Matériel de prêt'), "class"=>"no-pjax");
        }
        return $this->tabs;
    }
